...
import { Process } from '../../data/components/Process/ProcessCardStack';
...
export default function SimpleSaaSTemplate() {
  return (
    <div className="min-h-screen">
      ...
      <div className="space-y-8 pt-12 pb-24">
        <div className="mx-auto flex w-full max-w-[1910px] flex-col items-center space-y-8">
          <div className="text-center">
            <div style={{ fontSize: '16px', fontFamily: 'Inter', color: '#6D6D6D', marginBottom: '8px' }}>
              The best are already here
            </div>
            <a href="https://www.newcult.co" target="_blank" style={{ textDecoration: 'none' }}>
