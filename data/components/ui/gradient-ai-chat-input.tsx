...
export function GradientAIChatInput({
  ...
  const currentMainGradient = isDarkMode ? mainGradient.dark : mainGradient.light;
  const currentOuterGradient = isDarkMode ? outerGradient.dark : outerGradient.light;
  const currentButtonBorderColor = isDarkMode ? buttonBorderColor.dark : buttonBorderColor.light;
  const currentShadowColor = isDarkMode ? shadowColor.dark : shadowColor.light;
        ...
        {enableShadows && (
          <>
            ...
            <div
              ...
              style={{
                opacity: shadowOpacity,
                boxShadow: `0 10px 25px ${hexToRgba(currentShadowColor, isDarkMode ? 0.15 : 0.05)}`
              }}
            />
          </>
        )}
