...
export function VideoText({
  ...
  // Type assertion to ensure Component can accept children
  const ComponentWithChildren = Component as React.ComponentType<{ className?: string; children?: ReactNode }>
  ...
  return (
    <ComponentWithChildren className={cn(`relative size-full`, className)}>
